...
class UsersController extends AppController {
    ...
    public function login() {
        ...
        $this->log($this->Auth->login(), 'debug');
    ...
    public function index() {
        ...
        $this->set('Users', $this->User->query('select u.id, r.Role, u.FirstName, u.LastName, u.username, u.emailId, u.password, u.contactno, t.Telconame, i.IsActive, u.created, u.modified
...
where u.role=r.id and u.isactive=i.id and u.telconame=t.id ORDER BY created DESC'));
        if ($this->request->is('post')) {
            ...
            if ($this->request->data) {
                ...
                $this->set('Users', $this->User->query("select u.id, r.Role, u.FirstName, u.LastName, u.username, u.emailId, u.password, u.contactno, t.Telconame, i.IsActive, u.created, u.modified
from users u, Roles r, IsActives i, telconames t 
where u.role=r.id and u.isactive=i.id and u.telconame=t.id and (u.id like '%$searchParam%' or u.FirstName like '%$searchParam%' or u.lastname like '%$searchParam%'or u.username like '%$searchParam%'  or u.emailid like '%$searchParam%'"
