<body>
    <div id='cssmenu'>
        ...
        <ul>
            ...
            <li class = "active"> <?php echo $this->Html->link(__('Movies New'), array('controller' => 'MoviesNew', 'action' => 'displaymoviesnew')); ?></li>
...
echo $this->Html->link('Add Movie', array('controller' => 'MoviesContent', 'action' => 'displaymovies', 'movies_new')); ?>
<table>
    <tr>
        <th>Id</th>
        <th>Movie Id</th>
    ...
    <?php foreach ($movies as $movie): ?>
        <tr>
            <td><?php echo h($movie['MoviesNew']['id']); ?></td>

            <td><?php echo $movie['MoviesNew']['movie_id'];?></td>
